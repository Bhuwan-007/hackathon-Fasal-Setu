...
export const cropPrices: Record<string, CropPrice[]> = {
  ...
  Default: [
    { id: 'wheat', nameEn: 'Wheat', nameHi: 'गेहूं', pricePerQ: 2275, trend: 'up', changeAmount: 50, demandSignal: 'high' },
    { id: 'rice', nameEn: 'Rice (Paddy)', nameHi: 'धान', pricePerQ: 2183, trend: 'stable', changeAmount: 0, demandSignal: 'normal' },
    { id: 'tomato', nameEn: 'Tomato', nameHi: 'टमाटर', pricePerQ: 2400, trend: 'up', changeAmount: 150, demandSignal: 'high' },
    { id: 'onion', nameEn: 'Onion', nameHi: 'प्याज', pricePerQ: 1800, trend: 'down', changeAmount: 50, demandSignal: 'normal' },
    { id: 'potato', nameEn: 'Potato', nameHi: 'आलू', pricePerQ: 1200, trend: 'stable', changeAmount: 0, demandSignal: 'normal' },
    { id: 'soybean', nameEn: 'Soybean', nameHi: 'सोयाबीन', pricePerQ: 4600, trend: 'up', changeAmount: 120, demandSignal: 'high' },
    { id: 'cotton', nameEn: 'Cotton', nameHi: 'कपास', pricePerQ: 7100, trend: 'down', changeAmount: 200, demandSignal: 'low' },
    { id: 'mustard', nameEn: 'Mustard', nameHi: 'सरसों', pricePerQ: 5650, trend: 'stable', changeAmount: 0, demandSignal: 'normal' },
    { id: 'chickpea', nameEn: 'Chickpea (Chana)', nameHi: 'चना', pricePerQ: 5440, trend: 'up', changeAmount: 100, demandSignal: 'high' },
    { id: 'sugarcane', nameEn: 'Sugarcane', nameHi: 'गन्ना', pricePerQ: 315, trend: 'stable', changeAmount: 0, demandSignal: 'normal' },
    { id: 'maize', nameEn: 'Maize', nameHi: 'मक्का', pricePerQ: 2090, trend: 'stable', changeAmount: 0, demandSignal: 'normal' },
    { id: 'groundnut', nameEn: 'Groundnut', nameHi: 'मूंगफली', pricePerQ: 6377, trend: 'up', changeAmount: 80, demandSignal: 'high' },
    { id: 'bajra', nameEn: 'Bajra', nameHi: 'बाजरा', pricePerQ: 2500, trend: 'stable', changeAmount: 0, demandSignal: 'normal' },
    { id: 'turmeric', nameEn: 'Turmeric', nameHi: 'हल्दी', pricePerQ: 14000, trend: 'up', changeAmount: 500, demandSignal: 'high' },
    { id: 'chilli', nameEn: 'Red Chilli', nameHi: 'लाल मिर्च', pricePerQ: 18000, trend: 'down', changeAmount: 300, demandSignal: 'normal' },
  ],
};
